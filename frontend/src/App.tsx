...
const App: React.FC = () => {
  ...
  const uploadPDF = async () => {
    ...
    try {
      ...
      const res = await fetch(import.meta.env.VITE_URL_UPLOAD, {
        method: "POST",
        body: formData,
      });
  ...
  const askQuestion = async () => {
    ...
    try {
      ...
      const res = await fetch(import.meta.env.VITE_URL_ASK, {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-gray-100 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden flex-col md:flex-row">
        ...
        {/* LEFT PANEL */}
        <div className="w-full md:w-1/3 lg:w-1/4 p-5 border-b md:border-b-0 md:border-r border-[#2A2A2A] flex flex-col gap-6 bg-[#121212]">

          {/* Upload Section */}
          <div className="bg-[#1a1a1a] border border-[#2A2A2A] p-4 rounded-lg">
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-2">
              <FileText className="w-5 h-5 text-gray-400" /> Upload PDF
            </h2>
            ...
            <button
              ...
              className="mt-3 w-full bg-blue-600 hover:bg-blue-700 py-2 rounded-md text-white font-medium 
          ...
          <div className="bg-[#1a1a1a] border border-[#2A2A2A] p-4 rounded-lg">
            ...
            <button
              ...
              className="mt-3 w-full bg-green-600 hover:bg-green-700 py-2 rounded-md text-white 
              font-medium disabled:opacity-50 flex justify-center items-center gap-2"
            >
          ...
          <div className="bg-[#171717] border border-[#2A2A2A] p-6 rounded-xl min-h-full">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: formatMarkdown(answer || "Upload a PDF and ask a question."),
              }}
            />
          </div>
        </div>
